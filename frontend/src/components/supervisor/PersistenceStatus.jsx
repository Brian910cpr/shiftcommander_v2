        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Read-only save status for operator confidence.
            </p>
          </div>
        ...
        {error ? (
          ...
          <>
            ...
            <div className="grid gap-2 md:grid-cols-4">
              <DataPoint label="Availability store" value={availabilityTable} />
              <DataPoint label="Availability rows" value={loading ? 'Loading...' : status?.row_counts?.availability ?? 0} />
              <DataPoint label="Member store" value={usersTable} />
            ...
            <div className="rounded-lg border border-border/40 bg-muted/20 p-3 space-y-3">
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  <p className="text-xs font-semibold text-foreground">Shift Save Status</p>
                  <p className="text-[10px] text-muted-foreground">Schedule and seat update readiness.</p>
                </div>
              ...
              <div className="grid gap-2 md:grid-cols-3">
                ...
                <DataPoint label="Shift store" value={shiftsTable} />
            ...
            <p className="text-[10px] text-muted-foreground">
              Generated {status?.generated_at || 'after refresh'} from the live sync service.
            </p>
          </>
        )}
      </CardContent>
